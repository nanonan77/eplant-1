        ...
        public override IQueryable<UnplanSearchResult> OnQuery()
        {
            ...
            var query = from plantaion in Set<Plantation>()
                        ...
                        select new UnplanSearchResult
                        {
                            ...
                            Status = string.IsNullOrEmpty(plantaion.OverAllStatus) ? "Wait for Approve" : plantaion.OverAllStatus,
                            PIC = string.IsNullOrEmpty(plantaion.PIC) ? newReg.PIC : plantaion.PIC,
                            Approver1 = plantaion.Approver1,
                            Approver2 = plantaion.Approver2,
                            Approver3 = plantaion.Approver3,
                            StatusApprover1 = plantaion.StatusApprover1,
                            StatusApprover2 = plantaion.StatusApprover2,
                            StatusApprover3 = plantaion.StatusApprover3,
