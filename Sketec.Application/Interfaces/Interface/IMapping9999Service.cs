...
namespace Sketec.Application.Interfaces
{
    public interface IMapping9999Service : IApplicationService
    {
        ...
        //Task<Match9999Dto> GetMatch9999ForCreate(IEnumerable<Mapping9999ForCreate> request);
        Task CreateMacth9999(Mapping9999CreateRequest request);
        ...
        Task UploadMapping99999Excel(Mapping99999UploadExcel request);
    }
}
